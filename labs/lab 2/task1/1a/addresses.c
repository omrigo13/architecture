...
int addr5; //.......... section .bss uninitialized data
int addr6; //.......... section .bss uninitialized data

int foo(); //.......... section .bss uninitialized data
void point_at(void *p); //.......... section .bss uninitialized data
void foo1(); //.......... section .bss uninitialized data
void foo2(); //.......... section .bss uninitialized data

int main (int argc, char** argv){
    printf("size of long: %ld\n", sizeof(long));
    int addr2; //.......... section .bss uninitialized data
    int addr3; //.......... section .bss uninitialized data
    char* yos="ree"; //.......... section .data initialized data
    int * addr4 = (int*)(malloc(50)); //.......... section .bss uninitialized data
...
void point_at(void *p){ //p = addr5
    int local; //.......... section .bss uninitialized data
	static int addr0 = 2; //.......... section .data initialized data
    static int addr1; //.......... section .bss uninitialized data


    long dist1 = (size_t)&addr6 - (size_t)p; //.......... section .data initialized data
    long dist2 = (size_t)&local - (size_t)p; //.......... section .data initialized data
    long dist3 = (size_t)&foo - (size_t)p; //.......... section .data initialized data
